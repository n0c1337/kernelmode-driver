...
// Helper Macro
#define printk(text, ...) (DbgPrintEx(0, 0, text, ##__VA_ARGS__))

// Native C Kernel Functions
extern "C" {
...
// MSVC Linker is weird this can't be declared as ' extern "C" '
NTSTATUS NTAPI PsLookupProcessByProcessId(
	_In_	 HANDLE  	ProcessId,
	_Outptr_ PEPROCESS* Process
);

// Kernel Definitions (from https://doxygen.reactos.org/index.html)
